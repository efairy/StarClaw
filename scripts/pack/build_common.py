...
"""
Create a temporary conda env, install StarClaw from a wheel, run conda-pack.
...
def _pick_wheel(wheel_arg: str | None) -> Path:
    ...
    wheels = sorted(
        (REPO_ROOT / "dist").glob("starclaw-*.whl"),
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Conda-pack StarClaw (temp env).",
    )
    parser.add_argument(
        "--output",
        "-o",
    ...
    try:
        ...
        try:
            ...
            with tempfile.TemporaryDirectory() as tmpdir:
                ...
                # installing starclaw[full] later.
            ...
            print(
                ...
                "installing starclaw[full]"
            )
            needs_llama_compile = True

        # Install starclaw with all dependencies
