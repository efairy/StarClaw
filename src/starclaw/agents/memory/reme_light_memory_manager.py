...
# mypy: ignore-errors
"""ReMeLight-backed memory manager for StarClaw agents."""
...
from starclaw.agents.memory.base_memory_manager import BaseMemoryManager
from starclaw.agents.model_factory import create_model_and_formatter
from starclaw.agents.tools import read_file, write_file, edit_file
from starclaw.agents.utils import get_starclaw_token_counter
from starclaw.config import load_config
from starclaw.config.config import load_agent_config
from starclaw.constant import EnvVarLoader
...
class ReMeLightMemoryManager(BaseMemoryManager):
    """Memory manager that wraps ReMeLight for StarClaw agents via composition.
    ...
    async def compact_memory(
        ...
        **_kwargs,
        ...
        result = await self._reme.compact_memory(
            ...
            as_token_counter=get_starclaw_token_counter(agent_config),
        ...
        if not result.get("is_valid", True):
            ...
            try:
                ...
                logger.error(
                    ...
                    "https://github.com/efairy/StarClaw/issues",
                )
