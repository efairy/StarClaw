...
_USE_SYNC_PLAYWRIGHT = (
    sys.platform == "win32" and os.environ.get("STARCLAW_RELOAD_MODE") == "1"
)
...
def _ensure_playwright_async():
    ...
    try:
        ...
        raise ImportError(
            "Playwright not installed. Use the same Python that runs StarClaw (e.g. "
