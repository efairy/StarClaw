...
def app_cmd(
    ...
    if workers is not None:
        ...
        click.echo(
            "   StarClaw always uses 1 worker for stability. "
    ...
    if reload:
        os.environ["STARCLAW_RELOAD_MODE"] = "1"
    else:
        os.environ.pop("STARCLAW_RELOAD_MODE", None)
