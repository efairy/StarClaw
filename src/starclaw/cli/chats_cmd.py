...
def chats_group() -> None:
    ...
    \b
    Common examples:
      starclaw chats list                    # List all chats
      starclaw chats list --user-id alice    # Filter by user
      starclaw chats get <chat_id>           # View details
      starclaw chats create --session-id s1 --user-id u1
      starclaw chats delete <chat_id>        # Delete a chat
    """
...
def list_chats(
    ...
    Examples:
      starclaw chats list
      starclaw chats list --user-id alice
      starclaw chats list --channel discord
      starclaw chats list --user-id alice --channel discord
    """
...
def get_chat(
    ...
    \b
    CHAT_ID  Chat UUID, obtainable via `starclaw chats list`.
...
def create_chat(
    ...
    Inline creation examples:
      starclaw chats create --session-id "discord:alice" \\
    ...
    JSON file creation example:
      starclaw chats create -f chat.json
    """
    base_url = resolve_base_url(ctx, base_url)
...
def update_chat(
    ...
    \b
    Examples:
      starclaw chats update <chat_id> --name "Renamed Chat"
    """
    base_url = resolve_base_url(ctx, base_url)
    headers = {"X-Agent-Id": agent_id}
...
def delete_chat(
    ...
    \b
    Examples:
      starclaw chats delete 823845fe-dd13-43c2-ab8b-d05870602fd8
    """
    base_url = resolve_base_url(ctx, base_url)
    with client(base_url) as c:
        headers = {"X-Agent-Id": agent_id}
