# -*- coding: utf-8 -*-
"""CLI command: run StarClaw app on a free port in a native webview window."""
...
def desktop_cmd(
    ...
    """Run StarClaw app on an auto-selected free port in a webview window.
    ...
    window without conflicting with an existing StarClaw app instance.
    """
    ...
    click.echo(f"Starting StarClaw app on {url} (port {port})")
