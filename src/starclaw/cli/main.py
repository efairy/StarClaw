...
@click.group(
    ...
    lazy_subcommands={
        "app": ("starclaw.cli.app_cmd", "app_cmd", ".app_cmd"),
        "channels": (
            "starclaw.cli.channels_cmd",
            "channels_group",
            ".channels_cmd",
        ),
        "channel": (
        ...
        "daemon": ("starclaw.cli.daemon_cmd", "daemon_group", ".daemon_cmd"),
        "chats": ("starclaw.cli.chats_cmd", "chats_group", ".chats_cmd"),
        "chat": ("starclaw.cli.chats_cmd", "chats_group", ".chats_cmd"),
        "clean": ("starclaw.cli.clean_cmd", "clean_cmd", ".clean_cmd"),
        "cron": ("starclaw.cli.cron_cmd", "cron_group", ".cron_cmd"),
        "env": ("starclaw.cli.env_cmd", "env_group", ".env_cmd"),
        "init": ("starclaw.cli.init_cmd", "init_cmd", ".init_cmd"),
        "models": (
            "starclaw.cli.providers_cmd",
            "models_group",
            ".providers_cmd",
        ),
        "skills": ("starclaw.cli.skills_cmd", "skills_group", ".skills_cmd"),
        "uninstall": (
            "starclaw.cli.uninstall_cmd",
            "uninstall_cmd",
            ".uninstall_cmd",
        ),
        "desktop": ("starclaw.cli.desktop_cmd", "desktop_cmd", ".desktop_cmd"),
        "update": ("starclaw.cli.update_cmd", "update_cmd", ".update_cmd"),
        "shutdown": (
            "starclaw.cli.shutdown_cmd",
            "shutdown_cmd",
            ".shutdown_cmd",
        ),
