...
from starclaw.providers.provider import ModelInfo, Provider

if TYPE_CHECKING:
    from starclaw.providers.multimodal_prober import ProbeResult
    ...
    def _client(self, timeout: float = 5):
        if ollama is None:
            raise ImportError(
                ...
                "also need the Python SDK to manage models from StarClaw. "
                "Please install it with: pip install 'starclaw[ollama]'",
            )
