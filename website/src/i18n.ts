...
export const i18n: Record<Lang, Record<string, string>> = {
  zh: {
    ...
    "features.skills.desc": "内置定时任务，自定义技能目录，StarClaw 自动加载。",
    "testimonials.title": "社区怎么说",
    "testimonials.viewAll": "查看全部",
    "testimonials.1": "StarClaw 就该这样：多频道一个入口，Python 好改好部署。",
    "testimonials.2": "定时和心跳很实用，Skills 自己加，数据都在本地。",
    "testimonials.3": "想完全掌控的团队用着很顺手。",
    "usecases.title": "你可以用 StarClaw 做什么",
    "usecases.sub": "",
    ...
    "usecases.creative.1":
      "睡前向 StarClaw 说明目标并设定自动执行，次日即可获得可用的雏形。",
    "usecases.creative.2":
      "从选题、找素材到确定方向，StarClaw 可协助完成视频内容创作全流程。",
    ...
    "usecases.productivity.3":
      "记录饮食与身体反应，由 StarClaw 定期分析并呈现规律。",
    "usecases.research.1":
    ...
    "quickstart.hintAfter": "，即可通过钉钉、飞书、QQ 等频道使用 StarClaw。",
    ...
    "quickstart.desc.script":
      "无需手动配置 Python，一行命令自动完成安装。脚本会自动下载 uv（Python 包管理器）、创建虚拟环境、安装 StarClaw 及其依赖（含 Node.js 和前端资源）。注意：部分网络环境或企业权限管控下可能无法使用。",
  ...
  en: {
    ...
    "follow.sub": "Follow us for the latest StarClaw updates",
    ...
    "brandstory.title": "Why StarClaw?",
    "brandstory.para1":
      'StarClaw represents both a Co Personal Agent Workstation and a "co-paw"—a partner always by your side.',
    "brandstory.para2":
      'More than just a cold tool, StarClaw is a warm "little paw" always ready to lend a hand (or a paw!). It is the ultimate teammate for your digital life.',
    ...
    "usecases.title": "What you can do with StarClaw",
    "usecases.sub": "",
    ...
    "usecases.creative.1":
      "Describe your goal to StarClaw and set it to run overnight; get a working draft by the next day.",
    "usecases.creative.2":
      "From topic selection and material gathering to direction setting, StarClaw supports the full video content workflow.",
    "usecases.productivity.1":
    ...
    "usecases.productivity.3":
      "Log diet and symptoms; StarClaw analyzes and surfaces patterns over time.",
    "usecases.research.1":
    ...
    "quickstart.hintBefore":
      "Install → init → start. Configure channels to use StarClaw on DingTalk, Feishu, QQ, etc. See ",
    ...
    "quickstart.desc.script":
      "No Python setup required, one command installs everything. The script will automatically download uv (Python package manager), create a virtual environment, and install StarClaw with all dependencies (including Node.js and frontend assets). Note: May not work in restricted network environments or corporate firewalls.",
    "quickstart.desc.docker":
    ...
    "quickstart.badgeBeta": "Beta",
    footer: "StarClaw — Works for you, grows with you",
